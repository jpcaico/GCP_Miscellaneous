...
# Stations
station_source_object  = "from-git/stations/stations.csv"
...
# Regions
gcs_regions_source_object = "from-git/regions/regions.csv"
...
gcs_trips_source_object = "from-git/trips/trips.csv"
